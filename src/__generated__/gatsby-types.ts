...
type PortfolioPageQueryVariables = Exact<{ [key: string]: never; }>;


type PortfolioPageQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly frontmatter: Maybe<(
        Pick<MdxFrontmatter, 'hero_image_alt' | 'description' | 'url'>
