...
const IpadMesh: VFC = memo(() => {
  const tex = useLoader(THREE.TextureLoader, "ipad.png")
  ...
  const ShaderMaterial = shaderMaterial(
    ...
    glsl`
      ...
      void main() {
        ...
        vec3 pos = position;
        float noiseFreq = 0.5;
        float noiseAmp = 0.015;
        vec3 noisePos = vec3(pos.x * noiseFreq, pos.y * exponential(uTick), pos.z + cos(uTick));
